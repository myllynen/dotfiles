...
#  shopt -q login_shell && exec /bin/zsh -l -i || exec /bin/zsh -i
#fi
...
alias curl='curl -SLO'
type -P wget2 > /dev/null && alias wget='wget2 --no-hsts-file' || alias wget='wget --hsts-file=/dev/null'
...
function dud () {
	...
	case "$OSTYPE"
	in
		*cygwin*|*darwin*|*freebsd*|*gnu*|*linux*|*msys*|*netbsd*|*openbsd*|*solaris*)
			flags=sh
			;;
		*)
			flags=s
